            ...
            <div className={`${!isProductmode ? 'hide' : ''}`}>
              <div className='role-container-right'>
                <p>
                  ...
                  <a href="https://docs.google.com/document/d/1S5n352yPR5NFk1gulgvngmRFxT1J91fg" target="_blank" className='heyperlinkgeneral removeunderline'>General Guidelines</a>
